...
// same source as the web app's src/data/studentData.js — keep both in sync;
// swap for real API calls later without touching any screen
...
export const interests: Interest[] = [
  ...
  },
  {
    ...
    description: 'Alex writes short fiction outside of class and has started submitting to the school literary magazine.',
    evidence: [
    ...
    projects: [{ title: '"The Last Signal"', note: 'Sci-fi short story, published in the spring literary magazine' }],
